const Contact = () => {
  return (
    <section className="w-full h-auto min-h-[420px]">
      <div className="grid grid-cols-2 gap-2 mx-auto place-content-center w-full h-full">
        <div className="grid grid-cols-1 w-[67rem] h-full place-items-center gap-10 pl-64">
          ...
          <div className="flex flex-col p-6 justify-center items-center w-[45.8rem] h-[21.44rem] bg-[rgb(0,0,0,.05)]">
            <div className="flex flex-col items-center justify-center space-y-4 text-[#272727]">
